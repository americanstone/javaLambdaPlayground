...
public class A_Lambdas {
    ...
    public void a_predicate1() {
        Predicate<String> pred = string -> string.equals("abcde"); // TODO
    ...
    public void a_predicate4() {
        ...
        Predicate<String> startsWithJAndLengthIs7 = string -> startsWithJ.test(string) && lengthIs7.test(string); // TODO
    ...
    public void a_predicate5() {
        ...
        Predicate<String> lengthIs9orError = string -> lengthIs9.test(string) || equalsError.test(string); // TODO
    ...
    public void b_function1() {
        Function<String, String> func = string -> "("+string+")"; // TODO
    ...
    public void b_function4() {
        ...
        Function<String, Integer> lengthBis = string -> length.apply(unNullify.apply(string)); // TODO
    ...
    public void c_consumer4() {
        ...
        Consumer<List<String>> consumer = string -> {
        	c1.accept(string);
        	c2.accept(string);
        }; // TODO
    ...
    public void g_boundMethodRef1() {
        Function<String, Integer> func = string -> "abcdefghij".indexOf(string); // TODO
